...
@Component
public class AdminOrOrgFilter extends AbstractGatewayFilterFactory<AdminOrOrgFilter.Config> {
    public static class Config{

    }
    public AdminOrOrgFilter(){
        super(Config.class);
    }
    @Override
    public GatewayFilter apply(Config config) {
        return ((exchange, chain) -> {
            System.out.println("admin or org filter act");
            ...
            if(!role.equals("ADMIN") && !role.equals("ORG"))
