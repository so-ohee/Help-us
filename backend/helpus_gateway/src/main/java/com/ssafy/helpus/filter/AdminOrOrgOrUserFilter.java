...
@Component
public class AdminOrOrgOrUserFilter extends AbstractGatewayFilterFactory<AdminOrOrgOrUserFilter.Config> {
    public static class Config{

    }
    public AdminOrOrgOrUserFilter(){
        super(Config.class);
    }
    @Override
    public GatewayFilter apply(Config config) {
        return ((exchange, chain) -> {
            ...
            if(!role.equals("ORG") && !role.equals("USER") && !role.equals("ADMIN"))
